 ...
 * Discovery tool for the friendly names accepted by secedgar_get_financials,
 * secedgar_compare_companies, and secedgar_fetch_frames.
        ...
        z
          .object({
            name: z
              .string()
              .describe(
                'Friendly name to pass as `concept` to secedgar_get_financials or secedgar_fetch_frames, or in `concepts` to secedgar_compare_companies.',
              ),

...
| `secedgar://filing-types` | Common SEC filing types with descriptions, cadence, and use cases, plus the 8-K item-code decode tables for both numbering regimes |

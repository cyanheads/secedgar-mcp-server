...
| `concept-series` | `src/services/edgar/concept-series.ts` | Shared frame dedup + tag-priority resolution; one value per standard calendar period |
...
src/
  ...
  services/
    edgar/
      ...
      concept-series.ts                 # Shared frame dedup + tag priority over company facts
